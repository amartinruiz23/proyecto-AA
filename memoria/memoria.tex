...
\begin{itemize}
	...
	\begin{itemize}
	\item[-] El conjunto de datos presenta 15 columnas. Por ello vamos a intentar reducir aquellas que presenten poca o ningúna información haciendo un análisis por varianza, y eliminando aquellas columnas cuya varianza sea inferior a 0.1. Esto lo realizaremos con el algoritmo \texttt{varianceThreshold}\cite{einstein}.
	
	\item[-] Realizaremos un análisis de componentes principales PCA\cite{PCA}  para observar la varianza explicada por las variables restantes.
